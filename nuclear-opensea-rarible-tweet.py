...
hashtags_mentions = "#NuclearSnowflakeZNFT\n#NFT #NFTArt\n#NFTProject"
...
def sendTweet():
    links = ['https://opensea.io/assets/matic/0x40aff4cf882b28e748ea4bc9d20f587b76157482/','https://rarible.com/token/polygon/0x40aff4cf882b28e748ea4bc9d20f587b76157482:']

    payload = {
        "text": random.choice(greetings) + random.choice(links) + str(random.randint(1,100)) + "\n" + hashtags_mentions
    }
