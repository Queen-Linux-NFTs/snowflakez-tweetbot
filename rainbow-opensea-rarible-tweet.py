...
greetings = [
    ...
    'Hey, @rarible ! Shoutout for making a great platform for people to share their #NFTs :)\n',
    'SnowflakeZ keep falling on my head... Wait, it\'s supposed to be raindrops? Nah :p\n',
]

hashtags_mentions = "#RainbowSnowflakeZNFT\n#NFT #NFTArt\n#NFTProject"
...
def sendTweet():
    links = ['https://opensea.io/assets/matic/0x90253087c959b77f9b5b003a20cdac46a5e599a3/','https://rarible.com/token/polygon/0x90253087c959b77f9b5b003a20cdac46a5e599a3:']

    payload = {
        "text": random.choice(greetings) + random.choice(links) + str(random.randint(1,1000)) + "\n" + hashtags_mentions
    }
